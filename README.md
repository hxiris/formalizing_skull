...
The two counterexample-style traces below are easiest to read state-by-state rather than as one long strip. Open the interactive viewer to swipe through them one `State` at a time (works great on mobile):

**👉 [Open the interactive trace viewer](https://<your-username>.github.io/<your-repo>/)**
